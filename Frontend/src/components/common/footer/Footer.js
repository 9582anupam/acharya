    ...
    return (
        ...
        <div className="container mx-auto px-6">
            ...
            <div>
                ...
                <span className="ml-2 text-xl font-bold bg-gradient-to-r from-cyan-400 to-indigo-500 bg-clip-text text-transparent">Acharya-AI</span>
                </div>
            ...
            <p>&copy; {new Date().getFullYear()} Acharya-AI. All rights reserved.</p>
            </div>
        </div>
        </footer>
    );
