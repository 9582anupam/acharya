...
const AboutSection = () => {
    return (
        ...
        <div className="container mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">About Acharya-AI</h2>
            ...
            <p>
                Acharya-AI is a cutting-edge platform that leverages artificial intelligence to transform any content into 
